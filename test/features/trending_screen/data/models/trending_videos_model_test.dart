...
void main() {
  ...
  final tTrendingVideo = TrendsVideos();
  final video = Video();

  group('models equality checker', () {
    test('model equality to trending_video test', () {
      expect(tTrendingVideoModel, isA<TrendsVideos>());
    });

    test('should return true if TrendsVideos is Video', () {
      expect(tTrendingVideo, isA<Video>());
    });
  });
}
