...
class VideoDownloadingCubit extends Cubit<VideoDownloadingStates> {
  ...
  void videoDownloadingLoadingState() => emit(
  ...
  void videoDownloadingErrorState() => emit(
  ...
  void videoDownloadingGettingAudioInformationState() => emit(
  ...
  void videoDownloadingAudioState() => emit(
  ...
  void videoDownloadingSavingOnStorageState() => emit(
  ...
  void videoDownloadingLoadedState() => emit(
