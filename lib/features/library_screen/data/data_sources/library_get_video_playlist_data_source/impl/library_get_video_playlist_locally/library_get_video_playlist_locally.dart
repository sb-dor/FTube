...
class LibraryGetVideoPlaylistLocally
    implements LibraryGetVideoPlaylistDataSource {
  final DbFloor _dbFloor;

  LibraryGetVideoPlaylistLocally(this._dbFloor);

  @override
  Future<PlaylistModelDb?> videoPlaylist(
    BaseVideoModelDb? baseVideoModelDb,
  ) async {
    if (baseVideoModelDb == null) return null;
    final findVideoFirst = await _dbFloor.playListDao
