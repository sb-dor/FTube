...
class LibrarySetVideoInPlaylistLocally
    implements LibrarySetVideoInPlaylistDataSource {
  ...
  Future<void> setVideoInPlaylist(
    ...
    PlaylistVideosModelDb pListVideoModel =
        PlaylistVideosModelDb.fromEntity(video)!;
    ...
    await _dbFloor.playListDao.deleteVideoFromAllPlaylists(
      video.videoId ?? "0",
    );
